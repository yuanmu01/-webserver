...
public class ShowAllUserServelet extends  HttpServlet {
    private Logger log = Logger.getLogger(ShowAllUserServelet.class);
    public void doGet(HttpRequest request, HttpResponse response){
        log.info("ShowAllUserServlet:开始处理用户列表页面...");
      ...
      log.info("ShowAllUserServlet:用户列表页面处理完毕!");
    }
