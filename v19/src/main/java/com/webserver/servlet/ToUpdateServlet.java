...
public class ToUpdateServlet extends HttpServlet{
    private Logger log = Logger.getLogger(ToUpdateServlet.class);
    public void doGet(HttpRequest request, HttpResponse response){
        log.info("ToUpdateServlet:开始生成修改页面...");
        //获取超链接传递过来的用户名
...
//                    createHtml(response,name,pwd,nick,age);
        ...
        log.info("ToUpdateServlet:修改页面生成完毕!");
    }

    @Override
    public void doPost(HttpRequest request, HttpResponse response) {
        log.info("ToUpdateServlet:开始处理修改用户...");
        //真正完成用户修改操作....


        log.info("ToUpdateServlet:修改用户处理完毕!");
    }
